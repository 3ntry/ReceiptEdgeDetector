...
cv2.createTrackbar('lower','Image',1,255,nothing)
cv2.createTrackbar('upper','Image',1,255,nothing)
cv2.createTrackbar('aperture','Image',3,100,nothing)
...
while(1):
    ...
    data = "lower: " + str(lower) + " , upper: " + str(upper)
    print(data)

    # Apply canny edge detection.
    result = cv2.Canny(image, lower, upper, apertureSize = 3)
